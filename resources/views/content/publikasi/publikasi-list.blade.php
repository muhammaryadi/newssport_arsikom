...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Publikasi /</span> List Publikasi
</h4>
      ...
      <div class="row gy-4 gy-sm-1">
        <div class="col-sm-6 col-lg-3">
          <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
            <div>
              <h6 class="mb-2">Jumlah Publikasi</h6>
...
<div class="card">
  ...
  <div class="card-datatable table-responsive">
    <table class="datatables-article table" id="datatables-article">
